...
$ ->
  window.CompositionClasses = [ShapeSlideComposition, RandomShapeComposition, SphereReplication, CircleGrower, SphereSphereComposition, BlobbyComposition, FlameComposition]
